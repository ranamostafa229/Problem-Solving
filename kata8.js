...
/* (87) altERnaTIng cAsE <=> ALTerNAtiNG CaSe
...
/* (90) Be Concise IV - Index of an element in an array
Task
Provided is a function which accepts two parameters in the following order: array, element 
and returns the index of the element if found and "Not found" otherwise. 
Your task is to shorten the code as much as possible in order to meet the character count requirements
of the Kata.
...
/* (95) Compare within margin
Create a function close_compare that accepts 3 parameters: a, b, and an optional margin. The function should return whether a is lower than, close to, or higher than b.

Please note the following:

When a is close to b, return 0.
For this challenge, a is considered "close to" b if margin is greater than or equal to 
the absolute distance between a and b.
Otherwise...
...
/* (98) A Strange Trip to the Market
...
/* (100) Regex count lowercase letters
...
/* (104) Be Concise II - I Need Squares
Be Concise II - I Need Squares
You are given a program squaresOnly that accepts an array of natural numbers up to and including 100 
(and including 0) of length >= 1, array, 
...
There are a lot of handy built-in Array methods in Javascript that you may have never heard of even after
completing a basic course in Javascript (e.g. those provided by Codecademy) 
- well, at least I haven't heard of until quite recently. 
You may also want to research any new built-in methods offered by ES6, the newest specification of 
...
If either the heads & legs is negative, the result of your calculation is negative or the calculation 
is a float return "No solutions" (no valid cases), or [-1, -1] in COBOL.
...
function animals(heads, legs) {
  const chickens = heads - (legs / 2 - heads);
  const cows = legs / 2 - heads;
  if (heads === 0 && legs === 0) return [0, 0];
  if (heads < 0 || legs < 0 || chickens < 0 || cows < 0 || legs % 2 !== 0)
    return "No solutions";
...
// console.log(derive(9, 2)); // "18x^1"

/* (110) Student's Final Grade
